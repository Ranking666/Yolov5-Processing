...
#         elif m is C3:
#             name_base_conv1 = name_base + 'cv1'
#             name_base_conv2 = name_base + 'cv2'
#             name_base_conv3 = name_base + 'cv3'
#             cut_ids.append(name_base_conv1)
...
#             from_to[name_base_conv1] = [name_base_conv1, name_base_conv2]
#             from_layer.append(name_base_conv3)
#             for j in range(n):
#                 name_base_m_conv1 = name_base + "m.{}.cv1".format(j)
#                 name_base_m_conv2 = name_base + "m.{}.cv2".format(j)
