...
class C3(nn.Module):
    ...
    def __init__(self, c1, c2, c2_,  n=1, shortcut=True, g=1, e=[0.5, 0.5], ratio=[1.0 for _ in range(10)]):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()

        if isinstance(e, list):
            c_1 = int(c2_ * e[0])  # hidden channels
            c_2 = int(c2_ * e[1])
        else:
            c_1 = int(c2_ * e)
            c_2 = int(c2_ * e)
